...
Download [freebuilder-1.2-alpha1.jar][] and add it to the classpath (or
...
[freebuilder-1.2-alpha1.jar]: http://repo1.maven.org/maven2/org/inferred/freebuilder/1.2-alpha1/freebuilder-1.2-alpha1.jar
...
```
compile 'org.inferred:freebuilder:1.2-alpha1'
...
Download [freebuilder-1.2-alpha1.jar][] and [guava-18.0.jar][] and add them to your
...
**Add JARs**, and select `freebuilder-1.2-alpha1.jar`.
...
Download [freebuilder-1.2-alpha1.jar][] and [guava-18.0.jar][], add them to your
